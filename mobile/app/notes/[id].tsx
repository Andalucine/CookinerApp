/**
 * A note (session 9): title, the day it was changed and by whom, the text as it was written
 * (line breaks kept, it can be selected and copied) and Editar for the owner and editors.
 */
